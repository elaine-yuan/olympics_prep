...
FROM athletes a LEFT JOIN results r ON a.athlete_id=r.athlete_id
LEFT JOIN editions e ON r.edition_id=e.edition_id
...
JOIN sport_groups s ON d.sports_group_id=s.sports_group_id
